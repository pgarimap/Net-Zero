...
def get_hydrogen_production_by_tech(ssp_scenario):
    query_file = "/Users/pramish/Desktop/Codes/netzero/gcam_code/data/technology/hydrogen_production_by_tech.xml"
...
write_csv(df_1, 'spa1_hydrogen_production_by_tech', TOPICS.TECHNOLOGY)
write_csv(df_2, 'ssp2_hydrogen_production_by_tech', TOPICS.TECHNOLOGY)