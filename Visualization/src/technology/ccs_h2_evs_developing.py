...
fig = plt.figure(figsize=(FIG_DOUBLE_WIDTH, FIG_DOUBLE_WIDTH * 0.4))
...
plot_comparison(axs[0], df_developing_ccs_ssp2,
                df_developing_ccs, xs, title="CCS", ylabel="Sequestration (MTC)")
...
# plot evs
plot_comparison(axs[1], df_developing_evs_ssp2,
...
# set fig title as b
axs[1].text(-0.1, 1.1, 'B', transform=axs[1].transAxes, fontsize=7, fontweight='bold', va='top')

# plot h2
plot_comparison(axs[2], df_developing_h2_ssp2,
...
# set fig title as c
axs[2].text(-0.1, 1.1, 'C', transform=axs[2].transAxes, fontsize=7, fontweight='bold', va='top')
...
fig.legend(handles,
           ...
           bbox_to_anchor=(0.5, 0.009), fontsize=7)
